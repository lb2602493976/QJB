    ...
    <div class="drawer-content">
      <div class="drawer-view">
        <el-row type="flex" justify="start">
          ...
          <el-col style="padding:0 24px">
            <el-form :ref="formName" :model="formData" :rules="rules" :size="size" style="text-align:left;"
              :label-position="'top'" @keyup.enter.native="handleConfirm">
              <template>
                <div v-if="params.auditStatus==='0'">
                    <el-form-item label="审核结论" prop="auditStatus" :label-width="formLabelWidth">
                      <el-radio-group v-model.trim="formData.auditStatus">
                        <el-radio v-model.trim="formData.auditStatus" label="1">审核通过</el-radio>
                        <el-radio v-model.trim="formData.auditStatus" label="2">审核拒绝</el-radio>
                      </el-radio-group>
                    </el-form-item>
                </div>
              </template>
  ...
  export default {
    ...
    methods: {
      afterOpen(params){
        ...
        this.formData.auditStatus = String(params.auditStatus)
