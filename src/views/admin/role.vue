<template>
  ...
  <div class="app-container">
    ...
    <!-- 添加或修改对话框 -->
    <el-dialog :title="title" :visible.sync="dialogFormVisible" @close="handleResetForm">
      <el-form ref="form" :model="form" :rules="dataRule">

        <el-form-item label="角色名称" :label-width="formLabelWidth" prop="roleName">
          <el-input v-model.trim="form.roleName" auto-complete="off" placeholder="请输入角色名称" />
        </el-form-item>

        <el-form-item label="角色标识" :label-width="formLabelWidth" prop="roleCode">
          <el-input v-model.trim="form.roleCode" auto-complete="off" placeholder="请输入角色标识" />
        </el-form-item>

        <el-form-item label="角色介绍" :label-width="formLabelWidth" prop="roleDesc">
          <el-input v-model.trim="form.roleDesc" auto-complete="off" placeholder="请输入角色介绍" />
        </el-form-item>

        <el-form-item label="数据范围"  :label-width="formLabelWidth" prop="dsType">
          <el-select v-model.trim="form.dsType" placeholder="请选择数据范围" style="width: 100%" @change="changeScope">
            <el-option
        ...
        <el-form-item v-if="form.dsType === 4" label="数据权限" :label-width="formLabelWidth">
          <treeselect v-model.trim="deptIds" :options="deptData" multiple placeholder="请选择" />
        </el-form-item>
        ...
        <el-form-item label="访问菜单" :label-width="formLabelWidth">
          ...
          <div style="padding-left:24px;padding-top:12px;">
            <el-checkbox v-model.trim="checkAll" :disabled="false" @change="handleCheckAll"><b>全选</b></el-checkbox>
          </div>
        </el-form-item>
  ...
  data() {
    return {
      ...
      dataRule: {
        ...
        dsType:[{ required: true, message: '数据范围不能为空', trigger: 'change' }],
      },
      loading: false,
      deptIds: []
    }
