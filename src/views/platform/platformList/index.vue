  ...
  <div class="app-container">
    ...
    <div class="main">
      ...
      <Table ref="table" v-loading="loading" :page.sync="currentPage" :size.sync="pageSize" :has-page="true" @row-click="handleTableRowClick">
            ...
            <el-table-column label="气站名称" align="center">
              <template slot-scope="scope">
...
<script>
  import { getCarAccountList,addCarAccountList,exportTemp} from '@/api/ptAccount'
...
export default {
  ...
  methods: {
    ...
    handleTableRowClick(row) {
      ...
      this.$router.push({name:'platformListDetails',params:{value:this.currentEditParams}})
    },
    // 编辑界面
    editButton(row){
      // this.currentEditParams = { ...row }
