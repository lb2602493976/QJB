  ...
  <div>
    ...
    >
      <div class="drawer-content">
        <span style="border-bottom: 1px solid #1890FF;margin-left: 0em;font-size: 0.8em;color: #1890FF">申请信息</span>
        <br/>
        <div class="drawer-view" v-if="params.tenantType==='1'">
          <el-form
            :ref="formName"
            :model="params"
            :rules="rules"
          ...
          >
              ...
              <el-form-item label="充值账户" :label-width="formLabelWidth">
                <el-input v-model.trim="params.code" readonly  style="width: 280px"></el-input>
              </el-form-item>
              ...
              <el-row :gutter="20">
                <el-col :span="11">
                  <el-form-item :prop="'cardRechargeRecords.' + index +'.cardId'" :label-width="formLabelWidth" :rules="rules.cardId">
                    <el-select v-model.trim="item.cardId" placeholder="请选择气卡" @change="getValueCard">
                      <el-option
