      ...
      <el-dialog :append-to-body="true" :visible.sync="dialog" :title="isValueAdd ? '新增字典详情' : '编辑字典详情'" width="500px">
        <el-form ref="form" :model="form" :rules="rules" size="small" label-width="80px">
          <el-form-item label="名称" prop="itemText">
            <el-input v-model.trim="form.itemText" style="width: 370px;" />
          </el-form-item>
          <el-form-item label="数据值" prop="itemValue">
            <el-input v-model.trim="form.itemValue" style="width: 370px;" />
          </el-form-item>
          <el-form-item label="描述">
            <el-input v-model.trim="form.description" style="width: 370px;" />
          </el-form-item>
        </el-form>
