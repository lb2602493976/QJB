    ...
    >
      ...
      >
        <el-form-item label="数据库">
          <el-input v-model.trim="dataForm.tableSchema" :disabled="true" placeholder="请输入作者" />
        </el-form-item>
        <el-form-item label="表名称">
          <el-input v-model.trim="dataForm.tableName" :disabled="true" placeholder="请输入表名称" />
        </el-form-item>
        <el-form-item label="作者" prop="author">
          <el-input v-model.trim="dataForm.author" placeholder="请输入作者,例如小东啊" />
        </el-form-item>
        <el-form-item label="模块名称" prop="moduleName">
          <el-row>
            <el-col :span="22">
              <el-input v-model.trim="dataForm.moduleName" placeholder="请输入模块名称,例如pre-admin" />
            </el-col>
        ...
        <el-form-item label="项目包名称" prop="packageName">
          <el-row>
            <el-col :span="22">
              <el-input v-model.trim="dataForm.packageName" placeholder="请输入项目包名称 例如:com.xd.pre.modules.codegen" />
            </el-col>
            <el-col :span="2" class="icon-list__tips">
              <el-tooltip placement="top" effect="light" style="padding: 10px;">
                <div slot="content">
