  ...
  <div class="app-container">
    ...
    <div class="head-container" style="margin: 10px 0 10px 0;">
      ...
      <el-input
        ...
        class="filter-item"
      />
      <el-select v-model.trim="query.type" clearable placeholder="类型" class="filter-item" size="small" style="width: 130px">
        <el-option v-for="item in queryTypeOptions" :key="item.key" :label="item.display_name" :value="item.key" />
      </el-select>
      <el-button @click="getDictData" class="filter-item" size="small" type="primary" icon="el-icon-search" plain>搜索</el-button>
      <el-button
        class="filter-item"
        size="small"
        type="primary"
    ...
    <el-dialog :append-to-body="true" :visible.sync="dialog" :title="isAdd ? '新增字典' : '编辑字典'" width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="字典名称" prop="dictName">
          <el-input v-model.trim="form.dictName" style="width: 370px;" placeholder="请输入字典名称" />
        </el-form-item>
        <el-form-item label="字典编码" prop="dictCode">
          <el-input v-model.trim="form.dictCode" style="width: 370px;" placeholder="请输入字典编码" />
        </el-form-item>
        <el-form-item label="描述" prop="description">
          <el-input v-model.trim="form.description" style="width: 370px;" placeholder="请输入描述" />
        </el-form-item>
        <el-form-item label="备注">
          <el-input v-model.trim="form.remark" style="width: 370px;" placeholder="请输入备注" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    getDictData: function() {
      ...
      this.query.type && params.append(this.query.type, this.query.value)
