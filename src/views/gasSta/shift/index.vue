  ...
  <div class="app-container">
    ...
    <div class="main">
      ...
      <Table v-loading="loading" @row-click="handleTableRowClick" ref="table" :page.sync="currentPage" :size.sync="pageSize" :hasPage="true">
        ...
        <el-table-column label="班次名称" width="150" align="center">
          <template slot-scope="scope">
            <span>{{ scope.row.shiftName }}</span>
          </template>
        </el-table-column>

        <el-table-column label="班次时间" width="160" align="center">
          <template slot-scope="scope">
...
<script>
import { searchApi,createApi,updateApi,deleteApi } from '@/api/shift'
