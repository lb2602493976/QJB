<template>
    ...
    <div class="filter-container">
      <div class="filters">
        <div class="filter">
          <label class="label">接报人：</label>
          <el-input
            v-model.trim="params.criminalPeople"
            clearable
            class="filter-item"
            style="width: 200px;"
            size="small"
        ...
        <div class="filter">
          <label class="label">检修人：</label>
          <el-input
            v-model.trim="params.maintenancePeople"
            clearable
            class="filter-item"
            style="width: 200px;"
            size="small"
        ...
        <div class="filter">
          <label class="label">报（检）修时间：</label>
          <el-date-picker
