    ...
    >
        <div class="drawer-content">
            <el-row type="flex" justify="space-between" class="row">
                <el-col :span="labelSpan" class="label">气枪名称：</el-col>
                <el-col :span="contentSpan" class="content">{{params.name}}</el-col>
            </el-row>
            <el-row type="flex" justify="space-between" class="row">
                <el-col :span="labelSpan" class="label">燃气类型：</el-col>
                <el-col :span="contentSpan" class="content">{{ params.fuelGasType }}</el-col>
            </el-row>
            <el-row type="flex" justify="space-between" class="row">
                <el-col :span="labelSpan" class="label">启用状态：</el-col>
                <el-col :span="contentSpan" class="content">{{params.status|status}}</el-col>
            </el-row>
            <el-row type="flex" justify="space-between" class="row">
