  ...
  <div class="app-container">
    ...
    <div class="main">
      ...
      <Table v-loading="loading" @row-click="handleTableRowClick" ref="table" :page.sync="currentPage" :size.sync="pageSize" :hasPage="true">
        ...
        <el-table-column label="气枪名称" width="150" align="center">
          <template slot-scope="scope">
            <span>{{ scope.row.name }}</span>
          </template>
        </el-table-column>

        <el-table-column label="燃气类型" width="160" align="center">
          <template slot-scope="scope">
            <span>{{ scope.row.fuelGasType }}</span>
          </template>
        </el-table-column>
...
<script>
import { searchApi,createApi,updateApi,deleteApi } from '@/api/gun'
