<template>
  ...
  >
          ...
          <div >
            ...
            >
              <el-form-item label="审核结论" prop="status" :label-width="formLabelWidth">
                <el-radio-group v-model.trim="params.status" :rules="rules.status">
    ...
    <div class="drawer-content" v-if="params.activeName==='2'">
      <div class="drawer-view">
        <h2 style="border-bottom: 1px solid #1890FF;margin-left: -1em;font-size: 0.8em;color: #1890FF">还款信息</h2>
        <el-row type="flex" justify="space-between" class="row">
          <el-col :span="labelSpan" class="label">申请时间：</el-col>
          <el-col :span="contentSpan" class="content">{{ params.createTime }}</el-col>
        </el-row>
