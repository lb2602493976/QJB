<template>
  <div class="app-container">
    <!-- 标题 -->
    <h3 class="title">气站端车队账户</h3>
    <SearchForm ref="searchForm" :search-loading="loading"  @search="handleSearch" />
    <div class="main">
...
<script>
  import { getPlatformCarAccountList,exportTemp } from '@/api/gasAccount'
...
export default {
  ...
  methods: {
    ...
    handleTableRowClick(row) {
      ...
      this.$router.push({name:'gasDetails',params:{value:this.currentEditParams}})
    },
    // 编辑界面
    editButton(row){
      this.currentEditParams = { ...row }
