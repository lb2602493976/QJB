        ...
        <div class="drawer-view">
          ...
          >
              <el-form-item label="充值金额" prop="amount" :label-width="formLabelWidth">
                <el-input v-model="params.amount" placeholder="请输入" type="number" min="0"/>
              </el-form-item>
              <el-form-item label="交易流水号" prop="serialNumber" :label-width="formLabelWidth">
                <el-input v-model="params.serialNumber" placeholder="请输入" />
              </el-form-item>
              <el-form-item label="打款账户" prop="cashAccount" :label-width="formLabelWidth">
                <el-input v-model="params.cashAccount" placeholder="请输入" />
<!--                <el-date-picker-->
<!--                  v-model="params.cashAccount"-->
<!--                  style="width:100%"-->
<!--                  type="datetime"-->
<!--                  format="yyyy-MM-dd"-->
