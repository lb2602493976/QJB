...
export const getRechargeCard = (query) => {
  return request({
    url: '/sysOrder/getConsumeInfoGas',
    method: 'get',
    params: query
  })
}
...
export const exportTemp = (data) => {
  return axios({
    url:process.env.BASE_API + '/sysOrder/export/exportOrdersGas?tenantId='+data.tenantId+'&accountType='+data.accountType+'&startDate='+data.startDate+'&endDate='+data.endDate,
