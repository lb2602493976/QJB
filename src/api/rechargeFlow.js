...
export const getRechargeCard = (query) => {
  return request({
    url: '/recharge/getRechargeInfoFlat',
    method: 'get',
    params: query
  })
}
...
export const exportTemp = (data) => {
  return axios({
    url:process.env.BASE_API + '/recharge/export/exRechargeRecordsFlat?tenantId='+data.tenantId+'&accountType='+data.accountType+'&startDate='+data.startDate+'&endDate='+data.endDate,
